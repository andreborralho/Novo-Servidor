...
class FestivalsControllerTest < ActionController::TestCase
  ...
  test "should create festival" do
    assert_difference('Festival.count') do
      post :create, festival: { back_url: @festival.back_url, coord: @festival.coord, logo_url: @festival.logo_url, map_url: @festival.map_url, name: @festival.name }
    end
  ...
  test "should update festival" do
    put :update, id: @festival, festival: { back_url: @festival.back_url, coord: @festival.coord, logo_url: @festival.logo_url, map_url: @festival.map_url, name: @festival.name }
    assert_redirected_to festival_path(assigns(:festival))
  end
